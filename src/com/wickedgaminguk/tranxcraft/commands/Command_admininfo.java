...
public class Command_admininfo extends BukkitCommand<TranxCraft> {
    ...
    public boolean run(CommandSender sender, Command command, String commandLabel, String[] args) {
        ...
        if (args.length != 0) {
            ...
            sender.sendMessage(ChatColor.RED + "Don't beg for recommendations, this will get your application denied.");
